...
```
<p style="text-align: center;">Fig. 1: `ProfilePreview` component implementation</p>
...
```
<p style="text-align: center;">Fig. 2: Header from `View` component implementation, renders `ProfilePreview` component</p>
...
```
<p style="text-align: center;">Fig. 3: `HubListView` component dispatches an action to load the hubs after the component is mounted to the DOM (document object model)</p>
...
```
<p style="text-align: center;">Fig. 4: The `handleChange` function</p>
...
```
<p style="text-align: center;">Fig. 5: `fetchHubsSuccess` action which returns a type and a payload of `hubs`</p>
...
```
<p style="text-align: center;">Fig. 6: `fetchHubs` higher order action using the `HubService` class to get all hubs for a user</p>
...
```
<p style="text-align: center;">Fig. 7: `HubService` class `getAll` method implementation. This function gets all hubs for a specific user from an API, and returns all of the hubs.</p>
...
```
<p style="text-align: center;">Fig. 8: `hubReducer` function that returns a new state</p>
...
```
<p style="text-align: center;">Fig. 9: BEM classes being used in the `Login` view</p>
...
```
<p style="text-align: center;">Fig. 10: The `AddCodeView` component employs the use of form-related BEM classes</p>
...
```
<p style="text-align: center;">Fig. 11: Similarly the `Signup` component makes use of these classes</p>
...
```
<p style="text-align: center;">Fig. 12: Tests if the reducer returns the initial state when given an `undefined` state</p>
...
```
<p style="text-align: center;">Fig. 13: `utils.js` file that houses `validateToken` function middleware</p>
...
```
<p style="text-align: center;">Fig. 14: `validateToken` middleware is being used for these endpoints. To create a new hub and get hubs, a valid user token is required</p>
